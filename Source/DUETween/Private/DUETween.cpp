...
void FDUETweenModule::InitTweenPool()
{
	...
	SET_DWORD_STAT(STAT_TWEEN_POOL_SIZE, TWEEN_POOL_SIZE);
	SET_DWORD_STAT(STAT_ACTIVE_TWEENS, 0);
...
void FDUETweenModule::ExpandPool(const int& Amount)
{
	...
	INC_DWORD_STAT_BY(STAT_POOLED_TWEENS, TWEEN_POOL_SIZE - OldTweenPoolSize);
	SET_DWORD_STAT(STAT_TWEEN_POOL_SIZE, TWEEN_POOL_SIZE);
}
